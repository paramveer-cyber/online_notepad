            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li className="nav-item dropdown">
                        ...
                        <ul className="dropdown-menu active" aria-labelledby="navbarDropdown">
                            <li><button className="dropdown-item" onClick={cut_} title="Cut Text"><img src="https://w7.pngwing.com/pngs/696/896/png-transparent-gray-scissors-illustration-logo-scissors-cut-logo-scissors-application-thumbnail.png" alt="idk" width="25" />Cut</button></li>
                            <li><button className="dropdown-item" onClick={() =>  navigator.clipboard.writeText(textinput)} title="Copy Text"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-LllqQAm9HgKv8aiJogJCgcCE_YZF6Wy3k9T2sLg5xG6aQMlJ4M8Zr1_RRvq1i1kTgsU&usqp=CAU" alt="idk" width="25" />Copy</button></li>
                            <li><button className="dropdown-item"  onClick={paste_} id="paste_" title="Paste Text"><img src="https://e7.pngegg.com/pngimages/124/792/png-clipart-computer-icons-cut-copy-and-paste-clipboard-icon-design-font-symbol-miscellaneous-text.png" alt="idk" width="25" />Paste</button></li>
                            <li><button className="dropdown-item" onClick={selectAllText}  title="Select All"><img src="https://cdn-icons-png.flaticon.com/512/60/60833.png" alt="idk" width="25" />Select All</button></li>
                        </ul>
                    </li>
                </ul>
            </div>
